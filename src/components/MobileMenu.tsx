      ...
      >
        <div className="pt-20 px-6">
          ...
          <div className="mb-8 text-center">
            <h2 className="text-2xl font-bold text-amber-700 mb-2">沖縄カフェ</h2>
            ...
            {[
              ...
              <Link
                ...
                className={`block py-3 px-4 text-gray-700 hover:text-amber-600 text-lg font-medium transition-all duration-300 hover:bg-white hover:bg-opacity-50 rounded-lg transform ${
                  isOpen ? `translate-x-0 opacity-100 ${delay}` : 'translate-x-8 opacity-0'
                }`}
          ...
          {/* Language Toggle */}
          <div className={`mt-8 px-4 transform transition-all duration-500 ${
            isOpen ? 'translate-x-0 opacity-100 delay-500' : 'translate-x-8 opacity-0'
          }`}>
            <LanguageToggle />
          </div>

          {/* Decorative elements */}
          <div className={`mt-12 text-center transform transition-all duration-700 ${
            isOpen ? 'translate-y-0 opacity-100 delay-700' : 'translate-y-4 opacity-0'
          }`}>
