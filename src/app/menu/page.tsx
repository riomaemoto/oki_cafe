...
{items.map(item => {
          const imageUrls = {
            americano: 'https://images.unsplash.com/photo-1510707577719-ae7c14805e3a?q=80&w=500&auto=format&fit=crop',
            latte: 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?q=80&w=500&auto=format&fit=crop',
            cappuccino: 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?q=80&w=500&auto=format&fit=crop',
            okinawa_coffee: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&w=500&auto=format&fit=crop',
            matcha_latte: 'https://images.unsplash.com/photo-1515823064-d6e0c04616a7?q=80&w=500&auto=format&fit=crop',
            tropical_smoothie: 'https://images.unsplash.com/photo-1570197788417-0e82375c9371?q=80&w=500&auto=format&fit=crop',
            sandwich: 'https://images.unsplash.com/photo-1553979459-d2229ba7433a?q=80&w=500&auto=format&fit=crop',
          ...
          return (
            <div key={item.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 hover:scale-105">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/4 left-10 w-12 h-12 rounded-full overflow-hidden opacity-20 animate-float">
            <img src="https://images.unsplash.com/photo-1559056199-641a0ac8b55e?q=80&w=150&auto=format&fit=crop" alt="Coffee" className="w-full h-full object-cover" />
          </div>
          <div className="absolute top-1/3 right-10 w-10 h-10 rounded-full overflow-hidden opacity-20 animate-float-delayed">
            <img src="https://images.unsplash.com/photo-1490750967868-88aa4486c946?q=80&w=150&auto=format&fit=crop" alt="Flower" className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
